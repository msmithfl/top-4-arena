...
const LifePoints: React.FC<LifePointsProps> = ({ playerHP, maxHP }) => {
  return (
    <div className="flex flex-col bg-linear-to-r from-green-900 to-blue-900 bg-opacity-50 p-4 rounded-lg border-2 border-green-500">
      <div className='flex items-center justify-between'>
        <Heart className="mb-2 w-8 h-8 text-red-400" />
